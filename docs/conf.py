...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store']#, 'projectq.rst']#'backends.rst', 'ibm_backend.rst', 'projectq_backend.rst', 'projectq.rst']
...
latex_documents = [
    (master_doc, 'pytket.tex', 'pytket Documentation',
     'Cambridge Quantum Computing Ltd', 'manual'),
]
