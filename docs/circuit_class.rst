pytket._circuit.Circuit
==================================
.. currentmodule:: pytket._circuit.Circuit
.. class:: pytket._circuit.Circuit
...
An introduction to using the :py:class:`Circuit` class is given in getting_started.rst