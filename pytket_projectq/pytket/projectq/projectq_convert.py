...
def tk_to_projectq(engine:MainEngine,qureg:Qureg,circuit:Union[Circuit,PhysicalCircuit])->None:
    """
    A method to convert a tket Circuit to a series of ProjectQ commands
    in a register in an engine
    """
...
class tketOptimiser(BasicEngine):
    ...
    The optimisation passes have been left out, as the interface to tket
    """
    def __init__(self):
        BasicEngine.__init__(self)
        self._circuit = Circuit()
